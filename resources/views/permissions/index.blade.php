                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 mt-4 pt-3">
                            <button type="submit" class="btn btn-info btn-sm"><i class="fa-solid fa-magnifying-glass"></i>
                                Pesquisa</button>
                            <a href="{{ route('permission.index') }}" class="btn btn-danger btn-sm"><i
                            ...
                            <tr>
                                ...
                                <td class="d-md-flex flex-row justify-content-center">
                                    ...
                                    @can('show-permission')
                                        ...
                                        class="btn btn-primary btn-sm me-1 mb-1 mb-md-0"><i class="fa-regular fa-eye" title="Visualizar"></i>
                                        </a>
                                    @endcan
                                    ...
                                    @can('edit-permission')
                                        ...
                                        class="btn btn-warning btn-sm me-1 mb-1 mb-md-0"><i
                                            class="fa-regular fa-pen-to-square" title="Editar"></i></a>
                                    @endcan
                                        ...
                                        <form action="{{ route('permission.destroy', ['permission' => $permission->id]) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-danger btn-sm me-1"
                                                onclick="return confirm('Tem certeza que deseja apagar este registro?')"><i
                                                    class="fa-regular fa-trash-can" title="Apagar"></i></button>
                                        </form>
                                    @endcan
                                </td>
                            </tr>
