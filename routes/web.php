...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/generate-pdf-course', [CourseController::class, 'generatePdf'])->name('course.generate-pdf')->middleware('permission:generate-pdf-course');
    Route::get('/generate-csv-course', [CourseController::class, 'generateCsv'])->name('course.generate-csv')->middleware('permission:generate-csv-course');
